  ...
  return (
    <section id="projects" className="relative py-20 bg-black overflow-hidden">
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="aboslute top-1/2 right-1/3 w-96 h-96 bg-primary/10 opacity-20 rounded-full blur-3xl" />
      </div>

      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn delay={0}>
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-priamry/10 border border-primary/30 rounded-full mb-6">
        ...
        <FadeIn delay={200}>
          <div className="relative">
            <div
              ...
              className="overflow-x-auto scroll-smoth snap-x snap-mandatory hide-scrollbar"
            >
